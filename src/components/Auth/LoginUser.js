        ...
        <form class="w-full max-w-xl bg-white rounded-lg shadow-md p-6">
          <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full md:w-full px-3 mb-6">
              ...
              <input
              onChange={auth.emailHandler}
              value={auth.emailState.value}
            ...
            <div class="w-full md:w-full px-3 mb-6">
              ...
              <input
              onChange={auth.passHandler}
              value={auth.passState.value}
                class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-3 px-3 leading-tight focus:outline-none"
                type="password"
            ...
            <div class="w-full md:w-full px-3 mb-6">
              <button onClick={auth.formHandler} disabled={!auth.isValidForm} className={`appearance-none block w-full ${auth.isValidForm ? 'bg-green-500':'bg-red-500'} text-gray-100 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight hover:bg-blue-500 focus:outline-none focus:bg-white focus:border-gray-500`}>
                Sign in
              </button>
            </div>
